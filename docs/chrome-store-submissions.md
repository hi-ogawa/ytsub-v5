...
6. **Syncs bookmarks** (opt-in) — when signed in, the bookmarks page sends credentials and bookmark data to the project's own server (`zamak.hiroshi.workers.dev`) via CORS fetch. No host permissions needed.
